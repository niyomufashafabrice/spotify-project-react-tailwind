...
const Side2 = () => {
  return (
    <div className='bg-gray-900 w-[74%] rounded-xl py-[90px] h-[75vh] px-[30px] flex flex-col gap-[30px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-red-900'>
