...
const Side2 = () => {
  return (
    <div className='bg-gray-900 w-[74%] rounded-xl py-[40px] h-[80vh] px-[30px] flex flex-col gap-[30px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-red-900'>
     ...
     <div>
      ...
      <div className='artists flex gap-[0px]'>
        ...
        >
        <img src={data.img} alt="" className='h-[140px] w-[138px] object-cover rounded-lg' />
        ...
        className='group
            flex flex-col items-start hover:bg-gradient-to-b
             from-gray-900 to-gray-800 p-[10px] relative rounded-2xl
              transition-transform duration-300 cursor-pointer' key={data.id}
        >
        <img src={data.imagee} alt="" className='h-[140px] w-[138px] object-cover rounded-lg' />
