...
const Side2 = () => {
  return (
    <div className='bg-gray-900 w-[77%] rounded-xl py-[90px] h-[77vh] px-[30px] flex flex-col gap-[30px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-red-900'>
      ...
      <div className='artists flex gap-[0px]'>
        {
          ...
          return(
            ...
            flex flex-col items-start hover:bg-gradient-to-b
             ...
             <img src={item.img} alt="" className='h-[160px] w-[160px] object-cover rounded-full' />
        ...
        className='group
            flex flex-col items-start hover:bg-gradient-to-b
             from-gray-900 to-gray-800 p-[20px] relative rounded-2xl
              transition-transform duration-300 cursor-pointer' key={data.id}
        >
        <img src={data.imagee} alt="" className='h-[190px] w-[167px] object-cover' />
